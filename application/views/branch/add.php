<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('index.php/branch/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="branch_location" value="<?php echo $this->input->post('branch_location'); ?>" class="form-control" id="branch_location" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="assets" value="<?php echo $this->input->post('assets'); ?>" class="form-control" id="assets" />
						</div>
					</div>
				</div>
			</div>
