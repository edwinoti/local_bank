<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('index.php/user/edit/'.$user['user_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="account_name" value="<?php echo ($this->input->post('account_name') ? $this->input->post('account_name') : $user['account_name']); ?>" class="form-control" id="account_name" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="account_number" value="<?php echo ($this->input->post('account_number') ? $this->input->post('account_number') : $user['account_number']); ?>" class="form-control" id="account_number" />
